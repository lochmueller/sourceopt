...
$EM_CONF[$_EXTKEY] = [
    ...
    'description' => 'Optimization of the final page: reformatting the (x)html output, removal of new-lines, comments and generator-info including search and replace strings after page generation using your regular expressions. In addition combines all SVG selected within content-elements into one <symbol> file and replaces <img> by the corresponding <use>.',
    'category' => 'fe',
    'version' => '5.0.2',
    'state' => 'stable',
